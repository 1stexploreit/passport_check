<?php include('header.php');?>
   ...
   <!-- Header Start -->
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            ...
            <h1 class="text-white display-3 mb-5">Passport Checking </h1>
            <div class="mx-auto" style="width: 100%; max-width: 600px;">
			<form  enctype="multipart/form-data" action="passport_info.php" method="GET">
                <div class="input-group">
                    <input type="text" name="passport_no" class="form-control border-light" style="padding: 30px;" placeholder="Passport No">
                   <span id="status"></span>
				   <div class="input-group-append">
                        <button id="search-btn" type="submit" class="btn btn-primary px-3">Search</button>
                    </div>
                </div>
				</form>
 ...
 <!-- About Start -->
    ...
    <!-- Testimonial Start -->
    <div class="container-fluid py-5 bg-secondary mb-0">
        <div class="container">
            <div class="text-center pb-2">
