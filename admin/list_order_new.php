...
<div class="mt-4 mb-2 page-title">
 ...
 Booking <i class="fas fa-angle-right"></i>   New Booking
      </div>
             <div class="col-md-6 text-right">
	
		<a href="list_order_verified.php" class="btn btn-outline-primary"> <i class="fas fa-folder"></i> Verified</a>
      </div>
   </div>
</div>
<div class="card mb-4">
         ...
         <table class="table table-hover table-striped" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
               ...
               <tr>
				...
				<td nowrap>
				<a href="#" class="btn btn-success btn-sm order-update" data-order-id="<?php echo $row["order_id"]; ?>"> <i class="fa fa-check-circle"></i></a>
