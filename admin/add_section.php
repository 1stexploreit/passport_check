<?php include ('session.php'); 
	if(!empty($_POST["save"])) {
		...
		$itemCount = count($_POST["section"]);
		$itemValues=0;
		
		$query = "INSERT INTO tbl_section (section,clientid) VALUES ";
		$queryValue = "";
		for($i=0;$i<$itemCount;$i++) {
			if(!empty($_POST["section"][$i])) {
				...
				$queryValue .= "('" . $_POST["section"][$i] . "','" . $get_clientid . "')";
			}
		}
		...
		if($itemValues!=0) {
			...
			if(!empty($result)) $message = "Added Successfully.";
				...
				window.location.href='list_section.php';
				</script>");
		}
	}
...
<div class="mt-3 mb-3 page-title">
   <div class="row">
      <div class="col-md-10 my-auto">
         Profile <i class="fas fa-angle-right"></i> Add Section
      </div>
      <div class="col-md-2 text-right">
         <a href="list_section.php" class="btn btn-outline-primary"><i class="fas fa-folder-open"></i> All Section</a>
      </div>
   </div>
</div>
         ...
         <div class="all">
            <div class="formi">
               <div class="row items ">
                  ...
                  <div class="col-md-4">
                     <input class="form-control add" type="text" name="section[]">
                  </div>
                  <div class="col-md-1">
